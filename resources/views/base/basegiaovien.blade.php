...
<div>
	...
	<div class="container-fluid">
		<div class="navbar-header">	
			<a id="schoollogo" class="navbar-brand"   href="{!!route('giaovien')!!}"> <img id="logoanh" src="/nienluannew/public/image/laihoa.png"   ></a>
		</div>
		<div>
			<ul id="leftmenu" class="nav navbar-nav" >
				<li><a href= "" >Lớp Giảng dạy</a>
					<ul>
						<li>
							<a href= "" >Nhập điểm</a>
							<ul>
			...
			<ul id="logout" class="nav navbar-nav navbar-right" >
				<li >
					<a id="drop" href="#" class="dropdown-toggle" data-toggle="dropdown" >H01937 <b class="caret"></b></a>
					<ul >
